...
public class CustomDialog extends BaseDialogFragment {
    ...
    public void initViews(View v) {
        ...
        RelativeLayout alertDialogLayout = (RelativeLayout) v.findViewById(R.id.rlt_alert_dialog_layout);
        RelativeLayout prgresslayout = (RelativeLayout) v.findViewById(R.id.llt_progress_dialog);
