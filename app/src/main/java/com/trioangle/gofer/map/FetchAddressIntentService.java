...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (mReceiver == null) {
            DebuggableLogE(TAG, "No receiver received. There is nowhere to send the results.");
            return;
        }
        ...
        if (location == null) {
            errorMessage = getResources().getString(R.string.no_location_data_provided);
            DebuggableLogE(TAG, errorMessage);
        ...
        try {
            ...
            DebuggableLogE(TAG, errorMessage, ioException);
